     ...
     shiny::div(style = "width: 600px; max-width: 100%; margin: 0 auto; padding: 20px;",
        ...
        tagList(
          ...
          HTML("Seja bem-vindo(a)! <br/>  <br/>
               ...
               a("Github", href="https://github.com/ericaestatistica/Dados-Educacionais-MG")),
               HTML(
               "<br/><br/>
          ...
          body = dashboardBody(
            ...
            div(class = "span", tabsetPanel(
              ...
              tabPanel(
                ...
                fluidRow(
                  tabBox(
                    ...
                    tabPanel("Contexto e linguagem",texto_contexto_linguagem(),plotOutput("rshiny",height = "200px")),
              ...
              tabPanel(
                ...
                fluidRow(
                  column(7,offset=1,box(width=12,plotlyOutput("grafico_municipio",height = "800px"))),
